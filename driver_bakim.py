...
register_train_data(train_location, 'Bamberg_Hain', 1) # will take on all folds because not enough data
...
assert os.path.isdir(train_location)
register_train_data(train_location, "Tretzendorf_lower", 1)
...
out_dir = "../data/bakim/outputs/model2"
